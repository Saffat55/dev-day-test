import { trapFocus } from '@scripts/core/a11y'
...
function cartRedirect () {
  const cartTrigger = document.querySelector('[data-drawer-right-toggle]')
  if (window.location.href.indexOf('?cart_redirect') === -1 || !cartTrigger) { return }
  cartTrigger.click()
}
